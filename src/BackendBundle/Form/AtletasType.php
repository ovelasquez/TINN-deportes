...
class AtletasType extends AbstractType {
    ...
    public function buildForm(FormBuilderInterface $builder, array $options) {
        ...
        $builder
                ...
                ->add('altura', 'integer', array('required' => false, 'attr' => array('placeholder' => 'Altura (Cms)')))
                ->add('peso', 'integer', array('required' => false, 'attr' => array('placeholder' => 'Peso (Kgrs)')))
                ->add('tipoSangre', SangreType::class, array('required' => false,'placeholder' => 'Seleccione',))
                ->add('alergias', 'textarea', array('required' => false, 'attr' => array('rows' => '2', 'placeholder' => 'Alergias')))
                ->add('contactoNombre', 'text', array('required' => false, 'attr' => array('placeholder' => 'Nombre del Contacto en Caso de Emergencia')))
                ->add('contactoTelefono', 'text', array('required' => false, 'attr' => array('placeholder' => 'Teléfono de Contacto en Caso de Emergencia')))
